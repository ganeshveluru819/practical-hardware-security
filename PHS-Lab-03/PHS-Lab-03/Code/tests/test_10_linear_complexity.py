...
def linear_complexity_test(binary, M=512, K=6):
    """ Tests to see if the sequence can be generated using LFSRs.

    Args:
        M (int, optional): Size of LFSR to use. Defaults to 512.
        K (int, optional): Degrees of freedom to use for the test. Defaults to 6.
    """
