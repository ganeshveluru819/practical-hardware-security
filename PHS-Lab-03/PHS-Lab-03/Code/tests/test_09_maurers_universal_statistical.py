...
def maurers_universal_test(binary):
    """ 
        Maurer's universal statistical test tests the sequence's ability to be compressed without losing information.

        It does this by dividing the sequence into two segments, finding where every possible L-bit pattern occurs, and
        finding the distance between occurrences.
